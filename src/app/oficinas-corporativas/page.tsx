    ...
    <div className="bg-[#0a101f] min-h-screen text-white">
      ...
      <section className="relative h-[40vh] min-h-[400px] flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            <h1 className="font-playfair text-5xl md:text-7xl text-white mb-6">Oficinas <span className="text-gold italic">Corporativas</span></h1>
            <p className="text-white/60 max-w-2xl mx-auto uppercase tracking-widest text-sm">Nuestra red global al servicio de tu inversión inmobiliaria</p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          {offices.map((office, idx) => (
            <motion.div
              ...
              className="bg-[#121c30] border border-white/5 hover:border-gold/30 transition-all duration-500 overflow-hidden group"
            >
              <div className="relative h-48 overflow-hidden">
                ...
                <div className="absolute bottom-6 left-8">
                  <span className="text-gold text-xs font-bold uppercase tracking-widest bg-[#0a101f]/80 px-3 py-1 border border-gold/30">{office.country}</span>
                </div>
              </div>

              <div className="p-10">
                <h3 className="font-playfair text-3xl mb-2">{office.city}</h3>
                <p className="text-gold uppercase tracking-widest text-xs font-semibold mb-8">{office.title}</p>
      ...
      <section className="py-24 bg-gold/5 border-y border-gold/10 overflow-hidden relative">
        <div className="container mx-auto px-4 max-w-7xl relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="max-w-xl">
            <h2 className="font-playfair text-4xl mb-6">Un Respaldo <br /><span className="text-gold italic">Institucional Sólido</span></h2>
            <p className="text-white/70 leading-relaxed font-light mb-8">
              Como parte del Grupo CLERHP, nuestras oficinas internacionales no solo gestionan el desarrollo de Larimar City, sino que actúan como puentes de confianza para nuestros inversores en Europa, América y el Caribe.
            </p>
            <div className="flex items-center gap-8">
              <div className="text-center">
                <p className="text-3xl font-playfair text-gold">20+</p>
                <p className="text-[10px] uppercase tracking-widest text-white/40">Años de Exp.</p>
              </div>
              <div className="w-[1px] h-12 bg-white/10" />
              <div className="text-center">
                <p className="text-3xl font-playfair text-gold">4</p>
                <p className="text-[10px] uppercase tracking-widest text-white/40">Países Directos</p>
              </div>
              <div className="w-[1px] h-12 bg-white/10" />
              <div className="text-center">
                <p className="text-3xl font-playfair text-gold">10k+</p>
                <p className="text-[10px] uppercase tracking-widest text-white/40">Unidades en Proy.</p>
              </div>
            </div>
          </div>
          <div className="relative w-full max-w-md aspect-square rounded-full border border-gold/20 flex items-center justify-center">
            <Building2 className="w-32 h-32 text-gold/20" />
