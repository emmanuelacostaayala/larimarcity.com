...
const content = {
  es: {
    badge: "Fase I • Luxury Living",
    title: "Sunset Residences",
    desc: "Donde cada atardecer es una obra de arte. Un refugio de lujo diseñado para ofrecer experiencias sensoriales únicas con vistas infinitas al horizonte de Punta Cana.",
    cta: "Solicitar Disponibilidad",
    sec1Title: "Arquitectura de Inmersión",
    sec1Desc: "Sunset Residences redefine el concepto de \"hogar frente al mar\". Aunque ubicados estratégicamente en el farallón de Larimar, su arquitectura orgánica y sus amplias terrazas crean una conexión visual directa con el Mar Caribe. Es un espacio pensado para la relajación profunda y la exclusividad.",
    specsTitle: "Diferenciales Sunset",
    features: [
    ...
    vipTitle: "Carpeta del Proyecto",
    doc1: "Masterplan Sunset",
    doc1Size: "Documento • 2.5 MB",
    doc2: "Renders de Interior",
    doc2Size: "Galería • 15 MB",
    tableTitle: "Tipologías Disponibles",
    tableDesc: "Elija su espacio ideal en Sunset Residences.",
  ...
  en: {
    badge: "Phase I • Luxury Living",
    title: "Sunset Residences",
    desc: "Where every sunset is a work of art. A luxury retreat designed to offer unique sensory experiences with infinite views of the Punta Cana horizon.",
    cta: "Request Availability",
    sec1Title: "Immersive Architecture",
    sec1Desc: "Sunset Residences redefines the concept of \"oceanfront home.\" Although strategically located on the Larimar cliff, its organic architecture and expansive terraces create a direct visual connection with the Caribbean Sea. It is a space designed for deep relaxation and exclusivity.",
    specsTitle: "Sunset Differentials",
    features: [
      "Extra-deep terraces",
      "Uninterrupted sunset views",
      "Natural stone and wood finishes",
      "Smart Home ready",
      "Dedicated infinity edge pool",
      "VIP owners lounge",
      "24/7 concierge service",
      "Direct access to the Wellness zone"
    ],
    vipTitle: "Project Folder",
    doc1: "Sunset Masterplan",
    doc1Size: "Document • 2.5 MB",
    doc2: "Interior Renders",
    doc2Size: "Gallery • 15 MB",
    tableTitle: "Available Typologies",
    tableDesc: "Choose your ideal space at Sunset Residences.",
    moreInfo: "More information",
    units: [
      { type: "Sunset Horizon", area: "78 m²", price: "$128,000", note: "1 Bedroom" },
      { type: "Sunset Panoramic", area: "115 m²", price: "$185,000", note: "2 Bedrooms" },
      { type: "Sunset Royal", area: "195 m²", price: "$320,000", note: "3 Beds + Studio" },
    ]
  }
};
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative w-full h-[70vh] min-h-[600px] flex items-end pb-24 overflow-hidden bg-primary">
        <div className="absolute inset-0 z-0">
          ...
          <Image
            src="/images/original/sunset-residences-main.webp"
            ...
            {t.units.map((box, i) => (
              <div key={i} className="bg-white/5 border border-white/10 p-8 rounded-md hover:bg-white/10 transition-all group">
                ...
                <div className="flex items-center text-sm text-secondary font-medium group-hover:translate-x-1 transition-transform cursor-pointer">
                  {t.moreInfo} <ChevronRight className="ml-1 w-4 h-4" />
                </div>
              </div>
            ))}
          </div>
