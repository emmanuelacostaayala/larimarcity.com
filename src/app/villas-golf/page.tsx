        ...
        <div className="relative z-20 container mx-auto px-6 lg:px-12 flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div className="max-w-3xl">
            ...
            <p className="text-slate-200 text-lg md:text-xl font-light">
              La máxima expresión de privacidad. Residencias unifamiliares en primera línea de campo de golf con vistas panorámicas al horizonte y terminaciones de lujo europeo.
            </p>
          </div>
          <div className="shrink-0 flex flex-col gap-3 w-full md:w-auto">
            <button className="w-full md:w-auto px-8 py-4 bg-secondary text-white hover:bg-white hover:text-primary transition-colors flex items-center justify-center font-medium rounded-sm">
              Solicitar Masterplan de Villas <Calendar className="ml-2 w-4 h-4" />
            </button>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="grid lg:grid-cols-3 gap-16">
            <div className="lg:col-span-2">
              <h2 className="text-3xl font-playfair font-bold text-primary mb-6">Privacidad & Naturaleza</h2>
              <p className="text-slate-600 mb-6 leading-relaxed">
                Las Villas Golf han sido concebidas para aquellos que demandan discreción absoluta y una conexión íntima con el entorno. Situadas alrededor del campo de golf de 18 hoyos par 72, cada parcela ha sido seleccionada para garantizar vistas despejadas y una integración fluida entre la arquitectura y el paisajismo.
              </p>

              <h3 className="text-xl font-bold text-primary mt-10 mb-4">Especificaciones de Clase Mundial</h3>
            ...
            <div className="bg-stone-50 p-8 rounded-md border border-slate-100">
              <h3 className="text-xl font-bold text-primary mb-6 border-b border-slate-200 pb-4">Area VIP Inversores</h3>
              <div className="space-y-4">
                ...
                <Link href="#" className="flex items-center p-4 bg-white rounded-sm border border-slate-200 hover:border-secondary transition-all group">
                  ...
                  <div>
                    <p className="font-semibold text-primary">Planos de Modelos</p>
      ...
      <section className="py-20 px-6 lg:px-12 bg-primary text-white">
        <div className="container mx-auto max-w-5xl">
          <div className="mb-12 text-center">
            <h2 className="text-3xl font-playfair font-bold text-white mb-4">Disponibilidad de Parcelas</h2>
            <p className="text-slate-300 font-light">Unidades limitadas en primera línea de golf.</p>
          </div>
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-white/10 text-white uppercase text-xs tracking-wider">
                    ...
                    <th className="p-4 font-semibold">Parcela M²</th>
                ...
                <tbody className="divide-y divide-white/10 text-slate-200 text-sm">
                  {[
                    { type: "Villa Azure", beds: 3, sqft: "850 m²", price: "$450,000", status: "Disponible" },
                    { type: "Villa Emerald", beds: 4, sqft: "1,150 m²", price: "$680,000", status: "Pocas Unidades" },
                    { type: "Royal Estate", beds: "5+", sqft: "1,500 m²", price: "$1,200,000+", status: "Bajo Pedido" },
                  ].map((unit, i) => (
