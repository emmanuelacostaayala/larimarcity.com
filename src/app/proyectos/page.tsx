    ...
    <main className="min-h-screen bg-[#f8f9fa]">
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 px-8 bg-[#0a2e52] text-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-playfair mb-6">Colección Larimar</h1>
          <p className="text-lg md:text-xl text-white/80 max-w-2xl mx-auto font-light">
            Explora nuestro portafolio de proyectos residenciales. Diseños arquitectónicos de vanguardia integrados con la naturaleza de Punta Cana.
          </p>
        </div>
      </section>
